...
# Save the model
final_model.save_model("based/models/based_us_sans_trampush_early_stopping_combat_overfitting.ubj")
X_test.to_csv("data/train_test/based_us_Xtest_data_sans_trampush.csv")
y_test.to_csv("data/train_test/based_us_ytest_data_sans_trampush.csv")
X_train.to_csv("data/train_test/based_us_Xtrain_data_sans_trampush.csv")
y_train.to_csv("data/train_test/based_us_ytrain_data_sans_trampush.csv")
